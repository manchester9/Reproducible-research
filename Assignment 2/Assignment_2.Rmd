...
## Impact of severe weather on Public Health & Economy 

### Synopsis
This report aims to analyze the impact of different weather events on public health and economy collected from the U.S. National Oceanic and Atmospheric Administration's (NOAA) from 1950 - 2011.The report aims to find which weather events are the most destructive to the population's health and which weather events are the most destructive to the economy.
From the data it was depicted that excessive heat and tornado are most harmful with respect to population health, while flood, drought, and hurricane/typhoon have the greatest economic consequences.
...
### Stage 3: Creating property damages & crop damages datasets
```{r}
